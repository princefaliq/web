...
return [
    ...
    */
    ...
    'project_logo'   => '<b>Navigator</b>',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => false,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-pink border-0 navbar navbar-color',
    ...
    'sidebar_class' => 'sidebar sidebar-transparent bg-pink',
    // Remove "sidebar-transparent" for standard sidebar look
    // Try "sidebar-light" or "sidebar-dark" for dark/light links sidebar-pills
    ...
    // hide it with d-none
    // default with d-print-none
    // change background color with bg-dark, bg-primary, bg-secondary, bg-danger, bg-warning, bg-success, bg-info, bg-blue, bg-light-blue, bg-indigo, bg-purple, bg-pink, bg-red, bg-orange, bg-yellow, bg-green, bg-teal, bg-cyan, bg-white

    // Developer or company name. Shown in footer.
    'developer_name' => 'Faliqul',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'https://ict.polije.ac.id',
